...
public class IDE extends WebFrame {
    ...
    public static final String[] FLOW_KEYWORDS = new String[]{"declare", "getinput", "math", "print", "println", "random", "set", "fn", "void", "for", "end", "integer", "while", "if", "elseif", "else", "string", "boolean", "dowhile"};
